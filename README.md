...
To run model balancing in matlab, please have a look at the scripts in matlab/demo and adjust them to your model and data. For documentation of the matlab code, see matlab/doc.
