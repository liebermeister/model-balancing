% -------------------------------------------------------------
% Model "three_chain_model" (network structure from SBML or SBtab file)
%
% Network structure
% X1 <-> S2 <-> S3 <-> X4
%
...
filenames.kinetic_data = '/home/wolfram/projekte/model_balancing/github/model-balancing/resources/models/three_chain_model/data/artificial_kinetic.tsv';
filenames.state_data = '/home/wolfram/projekte/model_balancing/github/model-balancing/resources/models/three_chain_model/data/artificial_data.tsv';
